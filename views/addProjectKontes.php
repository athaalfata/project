...
<body>
    <div id="main">
        ...
        <form id="SignupForm" action="<?php echo site_url('project/project/verifikasiProjectKontes')?>" method="post">
            <fieldset>
            ...
            <fieldset>
                ...
                <table class="table">
                    ...
                    <tr>
                        <td><input type="checkbox" value="Fitur Project" name="FiturProject"></td>
                        <td>Fitur Project</td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="Project Urgent" name="ProjectUrgent"></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="Hidden Project" name="HiddenProject"></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="Project Komisi" name="ProjectKomisi"></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="Non-Disclosure Agreement" name="NonDisclosureAgreement"></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="Komunikasi Offline Online" name="OfflineOnline"></td>
                    ...
                    <tr>
                        <td><input type="checkbox" value="Verifikasi User" name="VerifikasiUser"></td>
            ...
            <p>
                <input id="buatProject" type="submit" value="Buat Project" name="buatProjectKontes" />
