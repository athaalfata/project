...
<body>
    <div id="main">
        ...
        <form id="SignupForm" action="<?php echo site_url('project/project/verifikasiProject')?>" method="post">
            <fieldset>
            ...
            <p>
                <input id="buatProject" type="submit" value="Buat Project" name="buatProject" />
